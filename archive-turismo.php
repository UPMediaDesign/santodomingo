...
function setMarkers(map, locations) {
  ...
  for (var i = 0; i < locations.length; i++) {
	...
	var content = '<img src="<?php bloginfo('template_directory')?>/images/logo.png" height="50" alt="" /><div class="clear miniseparator"></div><h3 class="pincontent">'+pin[6]+'</h3><h5>'+pin[0]+'</h5><div class="clear miniseparator"></div><a href="'+pin[5]+'" class="btn btn-block btn-success">Ver Más info <span class="fa fa-share"></span></a>';
